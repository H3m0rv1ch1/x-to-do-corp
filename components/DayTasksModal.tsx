...
const NoteListItem: React.FC<{ note: Note }> = ({ note }) => {
    ...
    return (
        ...
        >
            <StickyNote className="w-5 h-5 text-[rgba(var(--foreground-secondary-rgb))] mr-4 mt-1 flex-shrink-0" />
        ...
        >
            ...
            >
                <div className="flex items-center justify-between p-4 border-b border-[rgba(var(--border-primary-rgb))] flex-shrink-0">
                    ...
                    <button
                      onClick={onClose}
                      className="p-2 rounded-full hover:bg-[rgba(var(--background-tertiary-rgb))]"
                      aria-label="Close"
                    >
                      <X className="w-5 h-5" />
                    </button>
