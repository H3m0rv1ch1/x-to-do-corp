      ...
      {!isSearching && (
        <div className="sticky top-16 bg-[rgba(var(--background-primary-rgb),0.8)] backdrop-blur-md z-10 border-b border-[rgba(var(--border-primary-rgb))]">
          <div className="overflow-x-auto no-scrollbar">
            <div className="flex">
              <button onClick={() => setFilter('all')} className={`p-4 text-center whitespace-nowrap px-4 sm:flex-1 hover:bg-[rgba(var(--background-tertiary-rgb))] transition-colors duration-200 ${filter === 'all' ? 'font-bold border-b-2 border-[rgba(var(--accent-rgb))] text-[rgba(var(--accent-rgb))]' : 'text-[rgba(var(--foreground-secondary-rgb))]'}`}>All</button>
              <button onClick={() => setFilter('important')} className={`p-4 text-center whitespace-nowrap px-4 sm:flex-1 hover:bg-[rgba(var(--background-tertiary-rgb))] transition-colors duration-200 ${filter === 'important' ? 'font-bold border-b-2 border-[rgba(var(--accent-rgb))] text-[rgba(var(--accent-rgb))]' : 'text-[rgba(var(--foreground-secondary-rgb))]'}`}>Important</button>
              <button onClick={() => setFilter('pending')} className={`p-4 text-center whitespace-nowrap px-4 sm:flex-1 hover:bg-[rgba(var(--background-tertiary-rgb))] transition-colors duration-200 ${filter === 'pending' ? 'font-bold border-b-2 border-[rgba(var(--accent-rgb))] text-[rgba(var(--accent-rgb))]' : 'text-[rgba(var(--foreground-secondary-rgb))]'}`}>Pending</button>
              <button onClick={() => setFilter('completed')} className={`p-4 text-center whitespace-nowrap px-4 sm:flex-1 hover:bg-[rgba(var(--background-tertiary-rgb))] transition-colors duration-200 ${filter === 'completed' ? 'font-bold border-b-2 border-[rgba(var(--accent-rgb))] text-[rgba(var(--accent-rgb))]' : 'text-[rgba(var(--foreground-secondary-rgb))]'}`}>Completed</button>
            </div>
          </div>
        </div>
      )}
