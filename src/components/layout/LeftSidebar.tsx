...
const LeftSidebar: React.FC = () => {
    ...
    return (
        <aside className="sticky top-0 h-screen hidden md:flex flex-col w-[275px] min-w-[275px] flex-shrink-0">
            <div className="h-full w-full flex flex-col justify-between py-1 px-4">
                <div className="w-full">
                                ...
                                return (
                                    <li key={index}>
                                        <a
                                            ...
                                            className="flex items-center space-x-5 py-3 px-3 rounded-full transition-colors duration-200 hover:bg-[rgba(var(--background-hover-rgb))] w-fit"
                                        >
                                            <div>
                                                <Icon className="w-[26px] h-[26px]" />
                                            </div>
                                            <span className={`text-[20px] ${isActive ? 'font-bold' : ''} text-[rgba(var(--foreground-primary-rgb))]`}>{item.text}</span>
                                        </a>
                                    </li>
                                );
                            })}
                    ...
                    <button 
                        ...
                        className="mt-4 w-[90%] bg-[rgba(var(--button-primary-bg-rgb))] text-[rgba(var(--button-primary-text-rgb))] font-bold py-4 rounded-full transition-opacity duration-200 hover:opacity-90 text-[15px]"
                    >
                        Add Task
                    </button>
                </div>
                <div className="w-full pb-3">
                    <div 
                        ...
                        className="flex items-center space-x-3 p-3 rounded-full hover:bg-[rgba(var(--background-hover-rgb))] transition-colors duration-200 cursor-pointer"
                    >
                        ...
                        <div className="hidden md:block flex-1 overflow-visible">
                            ...
                            <p className="text-[rgba(var(--foreground-secondary-rgb))] text-[15px]">{userProfile.username}</p>
                        </div>
                    </div>
                </div>
            </div>
